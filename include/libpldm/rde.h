...
#define PLDM_GET_SCHEMA_DICTIONARY \
	PLDM_RDE_CMD_GET_SCHEMA_DICTIONARY
#define PLDM_GET_SCHEMA_URI \
	PLDM_RDE_CMD_GET_SCHEMA_URI
#define PLDM_RDE_ERROR_UNSUPPORTED \
	PLDM_RDE_CC_ERROR_UNSUPPORTED
#define PLDM_RDE_ERROR_NO_SUCH_RESOURCE \
	PLDM_RDE_CC_ERROR_NO_SUCH_RESOURCE

#define PLDM_GET_RESOURCE_ETAG \
	PLDM_RDE_CMD_GET_RESOURCE_ETAG
#define PLDM_GET_OEM_COUNT	PLDM_RDE_CMD_GET_OEM_COUNT
#define PLDM_GET_OEM_NAME	PLDM_RDE_CMD_GET_OEM_NAME
#define PLDM_GET_REGISTRY_COUNT PLDM_RDE_CMD_GET_REGISTRY_COUNT
#define PLDM_GET_REGISTRY_DETAILS \
	PLDM_RDE_CMD_GET_REGISTRY_DETAILS
#define PLDM_SELECT_REGISTRY_VERSION \
	PLDM_RDE_CMD_SELECT_REGISTRY_VERSION
#define PLDM_GET_MESSAGE_REGISTRY PLDM_RDE_CMD_GET_MESSAGE_REGISTRY
#define PLDM_GET_SCHEMA_FILE	  PLDM_RDE_CMD_GET_SCHEMA_FILE
#define PLDM_SUPPLY_CUSTOM_REQUEST_PARAMETERS \
	PLDM_RDE_CMD_SUPPLY_CUSTOM_REQUEST_PARAMETERS
#define PLDM_RETRIEVE_CUSTOM_RESPONSE_PARAMETERS \
	PLDM_RDE_CMD_RETRIEVE_CUSTOM_RESPONSE_PARAMETERS
#define PLDM_RDE_OPERATION_INIT	     PLDM_RDE_CMD_RDE_OPERATION_INIT
#define PLDM_RDE_OPERATION_COMPLETE  PLDM_RDE_CMD_RDE_OPERATION_COMPLETE
#define PLDM_RDE_OPERATION_STATUS    PLDM_RDE_CMD_RDE_OPERATION_STATUS
#define PLDM_RDE_OPERATION_KILL	     PLDM_RDE_CMD_RDE_OPERATION_KILL
#define PLDM_RDE_OPERATION_ENUMERATE PLDM_RDE_CMD_RDE_OPERATION_ENUMERATE
#define PLDM_RDE_MULTIPART_SEND	     PLDM_RDE_CMD_RDE_MULTIPART_SEND
#define PLDM_RDE_MULTIPART_RECEIVE   PLDM_RDE_CMD_RDE_MULTIPART_RECEIVE
...
int encode_rde_operation_complete_resp(uint8_t instance_id,
				       uint8_t completion_code,
				       struct pldm_msg *msg_buf);
/**
 * @brief Decode RDEOperationInit Resp
 *
 * @param[in] msg - Request message.
 * @param[in] payload_length - Request message lenght.
 * @param[out] completion_code - Pointer to completion Code
  * @return pldm_completion_codes.
 */
