 ...
 *  Refer to: DSP0248_1.3.0: 28.26 Table 104
 */
// Aligning structure members as per the PLDM RDE specification
...
/** @brief Free memory allocated for redfish resource pdr
 *
